"""
Open WebUI MCPO - main.py v0.0.57 (Python ClientSession protocol override)
...
APP_VERSION = "0.0.57"  # CHANGED from v0.0.56: Updated version to add Python ClientSession protocol override
        ...
        try:
            async with asyncio.timeout(45):
                ...
                if "gitmcp.io" in url.lower():
                    ...
                    logger.info("GitMCP initialized with protocol version 2024-11-05")
                else:
