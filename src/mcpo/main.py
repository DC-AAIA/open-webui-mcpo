"""
Open WebUI MCPO - main.py v0.0.38 (conservative mcp-remote addition)
                ...
                if "401" in str(e) or "Unauthorized" in str(e):
                    ...
                    try:
                        ...
                        try:
                            ...
                            raise Exception(f"All connection methods failed: {str(e)}, {str(fe)}, {str(mcp_remote_error)}")
                else:
